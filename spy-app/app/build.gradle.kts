...
android {
    ...
    signingConfigs {
        create("release") {
            storeFile = file(System.getenv("KEYSTORE_FILE") ?: "e:\\Settings\\keystore\\device-monitor.jks")
            storePassword = System.getenv("KEYSTORE_PASSWORD") ?: throw GradleException("KEYSTORE_PASSWORD environment variable not set")
            keyAlias = System.getenv("KEY_ALIAS") ?: "device-monitor"
            keyPassword = System.getenv("KEY_PASSWORD") ?: throw GradleException("KEY_PASSWORD environment variable not set")
